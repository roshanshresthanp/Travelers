    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                {!! Form::open(['action'=>'App\Http\Controllers\ContactController@store','method'=>'post','class'=>'form-contact contact_form','id'=>'contactForm']) !!}
                {{-- {!! Form::open(['route'=>'inquiry/add','method'=>'post','class'=>'form-contact contact_form','id'=>'contactForm']) !!} --}}
